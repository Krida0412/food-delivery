  ...
  return (
    ...
    >
      <div className="w-full flex items-center justify-between p-4 cursor-pointer">
        ...
        <p className="text-textColor text-lg font-semibold">Keranjang</p>
        <motion.p
          whileTap={{ scale: 0.75 }}
          className="flex items-center gap-2 p-1 px-2 my-2 bg-gray-100 rounded-md hover:shadow-md  cursor-pointer text-textColor text-base"
          onClick={clearCart}
        >
          Kosongkan <RiRefreshFill />
        </motion.p>
      </div>
      {cartItems && cartItems.length > 0 ? (
        <div className="w-full h-full bg-cartBg rounded-tl-[2rem] flex flex-col">
          ...
          {/* Total Section */}
          <div className="w-full flex-1 bg-cartTotal rounded-tl-[2rem] flex flex-col items-center justify-evenly px-8 pt-9 pb-48">
            <div className="w-full flex items-center justify-between">
              <p className="text-gray-400 text-lg">Sub Total</p>
              <p className="text-gray-400 text-lg">Rp {tot}</p>
            </div>
            <div className="w-full flex items-center justify-between">
              <p className="text-gray-400 text-lg">Ongkir</p>
              <p className="text-gray-400 text-lg">Rp 2.5</p>
            </div>
