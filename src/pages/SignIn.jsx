      ...
      <div className="relative px-4 py-10 bg-white mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
        <div className="max-w-md mx-auto">
          ...
          <div className="text-right mb-4">
            <a className="text-xs font-semibold text-gray-500 hover:text-gray-600 cursor-pointer">
              Lupa Password?
            </a>
          </div>
          ...
          <div className="flex flex-col items-center w-full">
            <button
              ...
              className="flex items-center justify-center py-2 px-20 bg-white hover:bg-gray-200 text-gray-700 w-full transition ease-in duration-200 font-semibold shadow-md rounded-lg"
            >
              <svg
                viewBox="0 0 24 24"
                height={25}
